...
final Map<String, ExerciseInfo> lib = {
  // ---- CHEST ----
  'Barbell Bench Press': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Chest, Front Delts, Triceps',
  ...
  'Incline Barbell Press': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Upper Chest, Front Delts',
  ...
  'Incline Dumbbell Press': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Upper Chest, Front Delts',
  ...
  'Flat Dumbbell Press': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Chest, Triceps',
  ...
  'Pec Deck Fly': const ExerciseInfo('Chest', 'front', ['chest'], [], 'Chest (isolation)',
  ...
  'Cable Crossover': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Chest (isolation)',
  ...
  'Push-Up': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Chest, Triceps, Core',
  ...
  'Machine Chest Press': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Chest, Triceps',
  ...
  'Smith Machine Bench Press': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Chest, Triceps',
  ...
  'Incline Cable Fly': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Upper Chest (isolation)',
  ...
  'Decline Dumbbell Press': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Lower Chest, Triceps',
  ...
  'Weighted Dips': const ExerciseInfo('Chest', 'front', ['chest'], ['frontDelts'], 'Lower Chest, Triceps',
  ...
  // ---- BACK ----
  'Wide Grip Lat Pulldown': const ExerciseInfo('Back', 'back', ['lats'], ['upperBack', 'rearDelts'], 'Lats, Upper Back',
      'Builds lat width for the V-taper.', ['Pull elbows down and in', 'Bar to the upper chest', 'Control the stretch at the top']),
  'Lat Pulldown': const ExerciseInfo('Back', 'back', ['lats'], ['upperBack', 'rearDelts'], 'Lats',
  ...
  'Chest Supported Row': const ExerciseInfo('Back', 'back', ['upperBack', 'lats'], ['rearDelts', 'traps'], 'Mid Back, Lats',
  ...
  'Assisted Pull-Up': const ExerciseInfo('Back', 'back', ['lats'], ['upperBack', 'rearDelts'], 'Lats, Upper Back',
  ...
  'Single Arm Lat Pulldown': const ExerciseInfo('Back', 'back', ['lats'], ['upperBack'], 'Lats (unilateral)',
  ...
  'Machine High Row': const ExerciseInfo('Back', 'back', ['upperBack', 'lats'], ['rearDelts'], 'Mid Back',
  ...
  'Reverse Grip Cable Row': const ExerciseInfo('Back', 'back', ['lats', 'upperBack'], ['biceps'], 'Lats, Biceps',
  ...
  'Pull-Up': const ExerciseInfo('Back', 'back', ['lats'], ['upperBack', 'rearDelts'], 'Lats, Upper Back',
  ...
  // ---- SHOULDERS ----
  'Overhead Press': const ExerciseInfo('Shoulders', 'front', ['frontDelts', 'sideDelts'], ['traps'], 'Shoulders (compound)',
  ...
  'Machine Shoulder Press': const ExerciseInfo('Shoulders', 'front', ['frontDelts', 'sideDelts'], [], 'Shoulders',
  ...
  'Dumbbell Lateral Raise': const ExerciseInfo('Shoulders', 'front', ['sideDelts'], ['traps'], 'Side Delts',
      'The key to shoulder width. High reps, strict form.', ['Lead with the elbows', 'Raise to shoulder height', 'Slight pour-the-jug tilt']),
  'Cable Lateral Raise': const ExerciseInfo('Shoulders', 'front', ['sideDelts'], [], 'Side Delts',
      'Constant cable tension on the side delts.', ['Cable behind the body', 'Lead with the elbow', 'Controlled down']),
  'Face Pull': const ExerciseInfo('Shoulders', 'back', ['rearDelts'], ['traps', 'upperBack'], 'Rear Delts, Upper Back',
  ...
  'Rear Delt Fly': const ExerciseInfo('Shoulders', 'back', ['rearDelts'], ['upperBack'], 'Rear Delts',
      'Direct rear-delt work for 3D shoulders.', ['Hinge forward slightly', 'Lead with elbows, wide arc', 'Pause at the top']),
  'Front Raise': const ExerciseInfo('Shoulders', 'front', ['frontDelts'], [], 'Front Delts',
      'Targets the front delts (usually a bonus after pressing).', ['Raise to eye level', 'No swinging', 'Controlled lowering']),
  'Dumbbell Shoulder Press': const ExerciseInfo('Shoulders', 'front', ['frontDelts', 'sideDelts'], ['triceps'], 'Shoulders',
  ...
  'Arnold Press': const ExerciseInfo('Shoulders', 'front', ['frontDelts', 'sideDelts'], ['traps'], 'All-round Shoulders',
  ...
  'Machine Lateral Raise': const ExerciseInfo('Shoulders', 'front', ['sideDelts'], [], 'Side Delts',
  ...
  'Upright Row': const ExerciseInfo('Shoulders', 'front', ['sideDelts', 'traps'], [], 'Side Delts, Traps',
  ...
  'Landmine Press': const ExerciseInfo('Shoulders', 'front', ['frontDelts'], ['chest'], 'Front Delts, Chest',
  ...
  'Preacher Curl': const ExerciseInfo('Arms', 'front', ['biceps'], [], 'Biceps (short head)',
  ...
  'Machine Tricep Extension': const ExerciseInfo('Arms', 'back', ['triceps'], [], 'Triceps',
  ...
  'Close Grip Bench Press': const ExerciseInfo('Arms', 'front', ['triceps'], ['chest'], 'Triceps, Chest',
  ...
  'Diamond Push-Up': const ExerciseInfo('Arms', 'front', ['triceps'], ['chest'], 'Triceps, Chest',
  ...
  // ---- LEGS ----
  'Barbell Squat': const ExerciseInfo('Legs', 'front', ['quads'], ['abs'], 'Quads, Glutes, Core',
  ...
  'Hack Squat': const ExerciseInfo('Legs', 'front', ['quads'], [], 'Quads, Glutes',
  ...
  'Leg Press': const ExerciseInfo('Legs', 'front', ['quads'], [], 'Quads, Glutes',
      'Loadable quad work without spinal fatigue.', ['Feet shoulder-width', 'Lower to ~90°', "Don't lock out hard"]),
  'Goblet Squat': const ExerciseInfo('Legs', 'front', ['quads'], ['abs'], 'Quads, Core',
  ...
  'Bulgarian Split Squat': const ExerciseInfo('Legs', 'front', ['quads'], ['abs'], 'Quads, Glutes',
  ...
  'Leg Extension': const ExerciseInfo('Legs', 'front', ['quads'], [], 'Quads (isolation)',
      'Pure quad isolation and a strong finisher.', ['Pause and squeeze at the top', 'Control the negative', 'Point toes to bias the sweep']),
  'Lying Leg Curl': const ExerciseInfo('Legs', 'back', ['hamstrings'], ['calves'], 'Hamstrings',
  ...
  'Seated Leg Curl': const ExerciseInfo('Legs', 'back', ['hamstrings'], ['calves'], 'Hamstrings',
      'Seated version emphasises the hamstrings under stretch.', ['Thighs locked down', 'Curl fully under', 'Controlled release']),
  'Hip Thrust': const ExerciseInfo('Legs', 'back', ['glutes'], ['hamstrings'], 'Glutes, Hamstrings',
  ...
  'Standing Calf Raise': const ExerciseInfo('Legs', 'back', ['calves'], [], 'Calves (gastrocnemius)',
      'Straight-leg raise for the larger calf muscle.', ['Full stretch at the bottom', 'Rise onto the big toe', 'Pause at the top']),
  'Seated Calf Raise': const ExerciseInfo('Legs', 'back', ['calves'], [], 'Calves (soleus)',
      'Bent knee targets the soleus.', ['Deep stretch each rep', 'Slow tempo', 'Squeeze at the top']),
  'Front Squat': const ExerciseInfo('Legs', 'front', ['quads'], ['abs'], 'Quads, Core',
  ...
  'Smith Machine Squat': const ExerciseInfo('Legs', 'front', ['quads'], ['abs'], 'Quads, Glutes',
  ...
  'Walking Step-Up': const ExerciseInfo('Legs', 'front', ['quads'], ['glutes'], 'Quads, Glutes',
  ...
  'Glute Bridge': const ExerciseInfo('Legs', 'back', ['glutes'], ['hamstrings'], 'Glutes',
  ...
  'Machine Hip Abduction': const ExerciseInfo('Legs', 'back', ['glutes'], [], 'Glutes (medius)',
  ...
  'Cable Woodchop': const ExerciseInfo('Core', 'front', ['abs'], [], 'Obliques, Core',
  ...
  'Hollow Body Hold': const ExerciseInfo('Core', 'front', ['abs'], [], 'Core (isometric)',
  ...
  'Ab Wheel Rollout': const ExerciseInfo('Core', 'front', ['abs'], [], 'Abs, Core',
  ...
  'Russian Twist': const ExerciseInfo('Core', 'front', ['abs'], [], 'Obliques',
